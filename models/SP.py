...
class SP(nn.Module):
    ...
    def objective(self, trail, train_data, val_data, epochs, num_classes):
        ...
        loss = train.train_objective(train_data=train_data,
    ...
    def transfer_train(self, params, epochs, train_data, val_data):
